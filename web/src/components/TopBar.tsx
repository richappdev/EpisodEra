...
import {BarChart3, Bookmark, LogIn, LogOut, Search, TrendingUp} from "lucide-react";

interface TopBarProps {
  activeView: "trending" | "search" | "watchlist" | "profile";
  user: User | null;
  onAuthOpen: () => void;
  onSignOut: () => void;
  onViewChange: (view: "trending" | "search" | "watchlist" | "profile") => void;
}
